...
<h3 class="mb-4 text-xl font-medium text-gray-900 text-center " >
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <i class="fa-solid fa-user-plus"></i>{{ __('S\'inscrire') }}
            </button>
        ...
        <div class="text-sm font-medium text-gray-500">
                ...
                <a class="underline text-smtext-blue-700 hover:underline rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" href="{{ route('login') }}">
                {{ __('Déjà enregistrer?') }}
                </a>
