    ...
    'selected' => $property->type
            ...
            <div class="col vstack gap-3" style="flex: 25">
                @foreach($property->pictures as $picture)
                    ...
                    <!-- <img src="{{ asset('storage/' . $picture->filename) }}" alt="Description de l'image" class="w-500 d-block"> -->

                    <!-- <img src="{{ asset('$picture->getImageUrl() ') }}" alt="Description de l'image" class="w-500 d-block"> -->
                    <!-- <img src="{{ asset($picture->getImageUrl()) }}" alt="Description de l'image" class="w-500 d-block"> -->

                        <img src="{{ $picture->getImageUrl() }}" alt="" class="w-500 d-block">
                        <button type="button"
