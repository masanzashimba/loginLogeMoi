    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <form method="POST" class="w-full px-4 md:w-1/2 lg:w-1/3" action="/todos/{{$todo->id}}">
                    @method('PUT')
                        @csrf
                        <div class="mb-6">
                            ...
                            name="title"
                             ...
                             <textarea     value="{{$todo->description}}" class="mt-1 border-form-stroke text-body-color placeholder-body-color focus:border-primary active:border-primary w-full rounded-lg border-[1.5px] py-3 px-5 font-medium outline-none transition disabled:cursor-default disabled:bg[#F5F7FD]"
