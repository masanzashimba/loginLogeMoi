...
@section('title', 'locationcourteduree')
...
<div class="hero">
        <div class="bgrsejour">
            ...
            <h2 class=" pinyon-script">Welcome</h2>
                ...
                <h1 class="dm-serif-display-regular">Séjourner avec LogeMoi en toute confiance</h1>
...
<div class="py-12 z-0">
        ...
        <h2 class=" lobster-regular">Nos derniers biens pour vos location à courte durée</h2>
