...
<head>
    ...
    <!-- <link rel="stylesheet" href="{{ asset('css/newstylecss.css') }}"> -->
...
<nav class="nav" >
  <div class="container">
     ...
     <ul>
      ...
      <li>  <a href="{{ route('admin.option.index') }}"  @class(['nav-link', 'active' => str_contains($route, 'option.')])>Gérer les options</a></li>
