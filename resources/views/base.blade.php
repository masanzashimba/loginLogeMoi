...
<link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link href="https://fonts.googleapis.com/css2?family=DM+Serif+Display:ital@0;1&family=Lobster&family=Pinyon+Script&family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&family=Roboto:ital,wght@0,100;0,300;0,400;0,500;0,700;0,900;1,100;1,300;1,400;1,500;1,700;1,900&display=swap" rel="stylesheet">


<link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link href="https://fonts.googleapis.com/css2?family=DM+Serif+Display:ital@0;1&family=Pinyon+Script&family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&family=Roboto:ital,wght@0,100;0,300;0,400;0,500;0,700;0,900;1,100;1,300;1,400;1,500;1,700;1,900&display=swap" rel="stylesheet">
 ...
 <nav class="nav" id="myNavbar">
  <div class="container">
     ...
     <ul>
      ...
      <li><a href="{{ route('locationdurelimite') }}">  Séjourné</a></li>
      ...
      <!-- <li>
      <a href="#" id="openModal" @class(['nav-link', 'active' => str_contains($route, 'property.')])>Gérer les biens</a>
      </li> -->
      <li><a href="#agents">Recherche d'agent</a></li>
      ...
      @if (Route::has('login'))
                    ...
                    @auth
                  <div class="dropdown">
                      <button class="button-61"> {{ Auth::user()->name }}</button>
                  ...
                  @else
                        <li><a href="{{ route('admin.property.index') }}" >    Se connecter</a></li>
    ...
    <!-- <span class="ml-2">50% de reduction 🏀</span> -->

    <span class="ml-2">50% de réduction <i class="fas fa-dollar-sign colfas"></i></span>

</a>
                <h1 class="dm-serif-display-regular">Découvrez votre nouvelle maison avec LogeMoi</h1>
     ...
     <div class="hero">
        <div class="heron">
            ...
            <a href=""
    class="animate-bounce focus:animate-none hover:animate-none inline-flex text-md font-medium bg-indigo-900 mt-3 px-4 py-2 rounded-lg tracking-wide text-white">
    <!-- <span class="ml-2">Compte Premium 🏀</span> -->
    <span class="ml-2">Compte Premium <i class="fas fa-star colfas"></i></span>

</a>
                <h1  class="regular">Vendez votre bien avec LogeMoi</h1>
                <!-- <input type="text" name="query" class="search-input" placeholder="Rechercher...">
                <button type="submit" class="search-button">Rechercher</button> -->
                <p><br>Découvrez votre futur chez nous. Nous sommes spécialisés 
                    dans l'immobilier, avec des conseils personnalisés pour chaque client. 
     ...
     <div class="hero">
      <div class="heroe">
        ...
        <a href=""
    class="animate-bounce focus:animate-none hover:animate-none inline-flex text-md font-medium bg-indigo-900 mt-3 px-4 py-2 rounded-lg tracking-wide text-white">
    <span class="ml-2">Voir nos biens <i class="fas fa-home colfas "></i></span>

</a>

            <h1 class="dm-serif-display-regular">Louez un appartement, une maison avec LogeMoi</h1>
            <!-- <input type="text" name="query" class="search-input" placeholder="Rechercher...">
            <button type="submit" class="search-button">Rechercher</button> -->
            <p><br>Découvrez votre futur chez nous. Nous sommes spécialisés 
                dans l'immobilier, avec des conseils personnalisés pour chaque client. 
...
<div class="movie">
<div data-testid="hops-rtb-card-1" class="movie1 transition duration-300 group transform hover:-translate-y-2 hover:shadow-2xl cursor-pointer border">
  <div class="Onsite">
    <div>
      <div>
...
<div class="posed">
<div class="grided">
    <h2 class="Texteconomie">Economisez 50% du mois de commision pour votre compte <span class="text-body-secondary">Logemoi vous facilite la vie </span></h2>
    <p class="StyledPara">Vous n'êtes pas sur un marché avec la nouvelle expérience de vente de LogeMoi&nbsp;? Travaillez avec un agent immobilier pour vous accompagner à chaque étape, y compris la préparation, l'inscription et la commercialisation de votre maison.</p>
    <div class="Spacerd"></div>
    <div class="StyledB">
      <div class="button11">
        <div class="button11-">
        <a href="#agents" class="Sty">Trouver un agent</a>

        </div>

      </div>
    </div>
    <p class="StyledParagraphS"><a href="">Apprenez à choisir un agent</a></p>
      <div class="ge"></div>
...
<div class="imageM">
        <figure class="figure1">
          <img src="{{ asset('images/ecomonisez.jpg') }}" alt="Vendre traditionnellement avec un agent" class="Image12">
        </figure>  
      </div>
</div>
...
<section>
<div class="min-h-screen bg-gray-800 py-6 flex flex-col justify-center sm:py-12" id="contact">
    <div class="relative py-3 sm:max-w-xl sm:mx-auto">
        ...
        <div class="text-white relative px-4 py-10 bg-indigo-400 shadow-lg sm:rounded-3xl sm:p-20">
            ...
            <div class="text-center pb-6">
                <h1 class="text-3xl">Contacter nous !</h1>
  ...
  <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 " id="agents">
      <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
          <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Notre équipe</h2>
          <p class="font-light text-gray-500 lg:mb-16 sm:text-xl dark:text-gray-400">Trouver un agent de LogeMoi pour vous accompagnez dans vos demarches de vente, location ou achat d'un bien</p>
      </div> 
